node {
    ...
    def GIT_URL='https://github.com/amalkurup/commercial-platform-final1234.git'
	def OS_PROJECT_NAME='commercial-services'
	def REPO_NAME='commercial-platform-final1234'
